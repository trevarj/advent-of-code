...
Learning Haskell for the first time. I already know a bit of the FP concepts and
syntax from exploring dependent types using Idris, so basically winging it from
there.
...
Trying to go for a comfortable run, without having to implement a lot of stuff.

### Possible Future Languages to Try
